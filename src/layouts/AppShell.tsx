  ...
  if (!isHseOfficer) {
    return (
      <div className="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        <header className="border-b border-slate-200 bg-white/90 backdrop-blur dark:border-slate-800 dark:bg-slate-900/90 sticky top-0 z-30">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 gap-3">
            <div className="flex items-center gap-3">
              <div className="relative grid size-9 place-items-center rounded-lg bg-blue-900 text-white font-mono text-xs font-black">
                H₂S
              </div>
              <div>
                <span className="font-display text-base font-black tracking-tight text-slate-900 dark:text-slate-100">H₂S GUARD</span>
                <span className="block text-[10px] font-semibold uppercase text-blue-600 dark:text-blue-400">
